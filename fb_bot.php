...
See: http://360percents.com/posts/php-curl-status-update-working-example/
*/
...
unset($ch);
/*========================================================================
2a. LOGIN: POST to facebook login form (formaction) with previously
...
unset($postdata);
/*========================================================================
2b. Fetch facebook.com/home.php to Collect parameters from the form which
...
//cleanup
curl_close($ch);
if(strlen($buf)>0){echo "[ERR] Status update response:$buf\n\n";}//something will probably appear here if it fails :)
unset($buf);
unset($ch);
unset($postdata);
/*========================================================================
